...
pip install -v -e .
```
2. Download the pre-trained ViTPose model `vitpose-h-multi-coco.pth` from [Hugging Face](https://huggingface.co/shauray/ViTPose/resolve/main/vitpose-h-multi-coco.pth). Put it below `./pose_detector` folder.
